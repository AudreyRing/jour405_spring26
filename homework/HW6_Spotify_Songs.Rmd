...
The dataset isn't a normal distribution, it is skewed left. The mean is at approximetly 0.7 which means the average song is pretty danceable. The fact that the distribution is skewed left means that overall there a lot more danceable songs and less dancebale ones are less common. 
