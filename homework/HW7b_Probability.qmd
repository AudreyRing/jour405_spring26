...
The distribution is skewed right. Most of the salaries cluster around the middle ranges roughly between $70,000 to $120,000. There are a few employees that earn very high salaries which pulls the mean up, creating the distribution to be skewed right. 
...
These results show that within 1 standard deviation is 65.9% which is lower than the expected 68%, within 2 standard deviations was 91.2% which is lower than the expected 95%, within 3 standard deviations was 100% which is slightly higher than the expected 99.7%. The deviations mean that the distribution is not perfectly normal. 
...
About 16.9% of White House employees are expected to earn more than $150,000 while the actual data shows that approximetly 18.2% do. This shows that the salaries aren't normally distributed and is skewed right. 
...
This means that approximatley 36.6% of the employees are expected to earn between $80,000 and $120,000 according to the normal distribution model but the actual data shows 32.6% are in that range. The middle range shows that many employees earn moderate salaries rather than super high or super low. Because of the fact that a third of employees make between $80,000 to $120,000 which means theres a strong middle range. 
...
It differs with the low salary ranges like few employees make below 60,000 and far more in the 60,000-90,000 range. This may be because there are very few low paying positions and because there are some people who make over $150,000 which makes it skewed and pulls the mean up. 
...
One in Three White House Staffers Earn Between $80k and $120k, accoring to data 
Lede: Approximatley 33% of White House employees make between $80,000 to $120,000, making this the most common salary range. On the other hand, about 18% of employees make more than $150,000, showing that there is a large middle tier and small group of high earners. 
Probability analysis can be used to compare the White House with other federal employees in other agencies to see if the pay structure is normal or unusual. Additional analysis could look at how the probabilities change by job title and if specific roles are more likley to be in the middle range or the few that are higher up. 
