...
The correlation between temperature and murders is 0.58, showing a pretty positive relationship. Meaning, as the temp increases, the number of murders tends to as well. The scatterplot shows this visuallt with the upward line and the summer months tend to cluster at the higher end of temperatures and murders. 
