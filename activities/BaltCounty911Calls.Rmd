...
The biggest thing that stands out to me is that in October there seems to be a spike in the data. During spring there also tends to be more calls. While, on the other hand, at the end of the chart near February it seems to have a low number of calls. It also looks like on new years day there is a spike in calls. 
...
It is similar to my answer in task 3, however, in this one you can see that for the unusually low days there are less at the start of the graph and more towards the end. While there is a spike at new years, then there are a lot of unusually low days that follow. 
...
Tuesday ad Thursday is shown to be the highest day of 3.3 and 3.09 which means that it is 3 standard deviation points away from the mean. This means that it is above the 95th percentile, meaning that it is extremely rare. 
...
I would definitely look into October as it was the highest spike (huge outlier) in calls and I would want to investigate why that is. Another pattern to look at would be to look at July since the 2nd and 3rd highest spike are only a few days apart. This was about a bad batch of drugs which would be an interesting story as well. 
