...
When looking at the sample versus the population mean and standard deviation, they are extremely close to each other. Mean went up only 1 number from sample to population. Standard deviation went down 1 from sample to population. When I decreased the sample size, the mean got closer to the population mean but the standard deviation went further away.
